...
if __name__ == "__main__":
    ...
    X_num_train, X_num_val, X_num_test = MH_Embedding.bins_discrete('ewde', X_num_train, X_num_val, X_num_test, bins=200)
    ...
    # X_cat_train, X_cat_val, X_cat_test = MH_Embedding.bins_discrete('ewde', X_cat_train, X_cat_val, X_cat_test, bins=200)
