...
class Tokenizer(nn.Module):
    ...
    def __init__(
        ...
        if multi_hot_params:
            ...
            d_bias = multi_hot_params["num_feature"] * multi_hot_params["emb_size"]
    ...
    def forward(self, x_num: Tensor, x_cat: ty.Optional[Tensor]) -> Tensor:
        ...
        x_num = self.multi_hot_embedding(x_num)
        x_cat = self.multi_hot_embedding(x_cat)
